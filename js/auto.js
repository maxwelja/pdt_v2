...
function autoIt(){
    ...
    class player{
        ...
        event(){
            ...
            context.fillRect(this.x+2, this.y+2,296,296);
            context.fillStyle = "white";
            context.fillRect(this.x+4, this.y+4,292,292);
            context.restore();
        }
        draw(){
            context.save();
            this.rotate();
            if (this.id == 1){
                context.drawImage(p1Img, this.x-(this.width/2), this.y-(this.height/2), this.width, this.height);
            } else if (this.id == 2){
                context.drawImage(p2Img, this.x-(this.width/2), this.y-(this.height/2), this.width, this.height);
            } else if (this.id == 3){
                context.drawImage(p3Img, this.x-(this.width/2), this.y-(this.height/2), this.width, this.height);
            }
            context.restore();  
        }
        rotate(){
    ...
    function init(){
        p1 = new player(CENTER_X-150,CENTER_Y-60,75,50,"red",1);
        p2 = new player(CENTER_X,CENTER_Y-60,75,50,"blue",2); 
        p3 = new player(CENTER_X+150,CENTER_Y-60,75,50,"green",3);

        block1 = new entity(975,400,200,100,"darkred",1);
        block2 = new entity(1050,500,100,200,"darkred",2);
        block3 = new entity(950,400,100,100,"darkred",3);
        ...
        block7 = new entity(200,250,50,50,"darkgreen",7);
        block8 = new entity(200,350,50,50,"darkgreen",8);
        block9 = new entity(300,350,50,50,"darkgreen",9);
        block10 = new entity(300,250,50,50,"darkgreen",10);
        block11 = new entity(SCREEN_WIDTH-50,SCREEN_HEIGHT-200,10,25,"goldenrod",11);
        colFlag = false;
    ...
    */
    ...
    function render(){
        ...
        console.log(colFlag, point);

        //draw all entities; player last
        for (let i = 0; i < allEntities.length; i++){
            allEntities[i].draw();
            allEntities[i].update();
            if (i < allEntities.length - NUMPLAYERS){
                if (p1.colliderRect(allEntities[i])){
                    p1.event();
                }
                if (p2.colliderRect(allEntities[i])){                
                    p2.event();
                }
                if (p3.colliderRect(allEntities[i])){
                    p3.event();
                }
            }
            console.log(point);
