...
function homeIt(s){
    ...
    class player{
        ...
        draw(){
            context.save();
            this.rotate();
            context.drawImage(homeImg, this.x-(this.width/2), this.y-(this.height/2), this.width, this.height);                
            context.restore();  
        }
        rotate(){
    ...
    function init(s){
        ...
        block1 = new entity(1050,100,10,25,"goldenrod",1);
        block2 = new entity(1000,200,10,25,"goldenrod",2);
        block3 = new entity(700,50,25,10,"goldenrod",3);
        ...
        block7 = new entity(175,200,25,10,"goldenrod",7);
        block8 = new entity(75,450,25,10,"goldenrod",8);
        block9 = new entity(450,550,10,25,"goldenrod",9);
        block10 = new entity(350, 100, 10, 25,"goldenrod",10);
        ...
        for (let i = 0; i < allEntities.length-NUMPLAYERS; i++){
            ...
            if (p1.colliderRect(allEntities[i]) ||
                ...
                p3.colliderRect(allEntities[i]) ){
                    window.setInterval(calcPoint(allEntities[i]), 1000);
                }
    ...
    function render(){
        ...
        console.log(colFlag, point, score);
        // console.log(allEntities[i].eID);
        // console.log(p1.x, p1.y, p1.edges);
        // console.log(p2.x, p2.y, p2.edges);
        // console.log(p3.x, p3.y, p3.edges);
